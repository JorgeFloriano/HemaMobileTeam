...
// const API_BASE_URL = "http://192.168.0.110/Hema/public/api"; // Replace with your IP, localhost, home
const API_BASE_URL = "http://192.168.18.54/Hema/public/api"; // Replace with your IP, localhost
...
api.interceptors.request.use(async (config) => {
  ...
  if (!csrfToken) {
    try {
      ...
      await axios.get("http://192.168.18.54/Hema/public/sanctum/csrf-cookie", {
